...
**GIT** 是目前主流的[分布式版本控制系统](https://git-scm.com/book/zh/v2/%E8%B5%B7%E6%AD%A5-%E5%85%B3%E4%BA%8E%E7%89%88%E6%9C%AC%E6%8E%A7%E5%88%B6#分布式版本控制系统)。

[GIT 详细文档点击这里](https://git-scm.com/book/zh/v2/)
...
文中`Pull Request`的介绍用的是`Bitbucket`代码托管服务，由于和`GITLAB`基本一样，如果你用的是`GITLAB`（我自己也主要使用`GITLAB`托管代码），不影响理解和操作。
...
![Git Workflows](/uploads/images/posts/git/basic/git_workflow.png)

## 集中式工作流

如果你的开发团队成员已经很熟悉`Subversion`，集中式工作流让你无需去适应一个全新流程就可以体验`Git`带来的收益。这个工作流也可以作为向更`Git`风格工作流迁移的友好过渡。
![Git Workflows: SVN-style](/uploads/images/posts/git/basic/git-workflow-svn.png)
...
![git-workflow-svn-push-local](/uploads/images/posts/git/basic/git-workflow-svn-push-local.png)

### 冲突解决

中央仓库代表了正式项目，所以提交历史应该被尊重且是稳定不变的。如果开发者本地的提交历史和中央仓库有分歧，`Git`会拒绝`push`提交否则会覆盖已经在中央库的正式提交。

![git-workflow-svn-managingconflicts](/uploads/images/posts/git/basic/git-workflow-svn-managingconflicts.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-initialize.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-clone.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-1.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-2.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-3.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-4.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-5.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-6.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-7.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-8.png)
...
![](/uploads/images/posts/git/basic/git-workflow-svn-9.png)
...
![Git Workflows: Feature Branch](/uploads/images/posts/git/basic/git-workflow-feature_branch.png)

![](/uploads/images/posts/git/basic/git-workflow-feature-branch-1.png)
...
![](/uploads/images/posts/git/basic/git-workflow-feature-branch-2.png)
...
![](/uploads/images/posts/git/basic/git-workflow-feature-branch-3.png)
...
![](/uploads/images/posts/git/basic/git-workflow-feature-branch-4.png)
...
![](/uploads/images/posts/git/basic/git-workflow-feature-branch-5.png)

小黑收到了`Pull Request`后会查看`marys-feature`的修改。决定在合并到正式项目前是否要做些修改，且通过`Pull Request`和小红来回地讨论。

#### 小红再做修改

![](/uploads/images/posts/git/basic/git-workflow-feature-branch-6.png)
...
![](/uploads/images/posts/git/basic/git-workflow-feature-branch-7.png)
...
![Git Workflows: Gitflow Cycle](/uploads/images/posts/git/basic/git-workflows-gitflow.png)
...
![](/uploads/images/posts/git/basic/git-workflow-release-cycle-1historical.png)
...
![](/uploads/images/posts/git/basic/git-workflow-release-cycle-2feature.png)

注意，从各种含义和目的上来看，功能分支加上`develop`分支就是功能分支工作流的用法。但`Gitflow`工作流没有在这里止步。

### 发布分支

![](/uploads/images/posts/git/basic/git-workflow-release-cycle-3release.png)
...
![](/uploads/images/posts/git/basic/git-workflow-release-cycle-4maintenance.png)
...
![](/uploads/images/posts/git/basic/git-workflow-release-cycle-5createdev.png)
...
![](/uploads/images/posts/git/basic/git-workflow-release-cycle-6maryjohnbeginnew.png)
...
![](/uploads/images/posts/git/basic/git-workflow-release-cycle-7maryfinishes.png)
...
![](/uploads/images/posts/git/basic/git-workflow-release-cycle-8maryprepsrelease.png)
...
![](/uploads/images/posts/git/basic/git-workflow-release-cycle-9maryfinishes.png)
...
![](/uploads/images/posts/git/basic/git-workflow-gitflow-enduserbug.png)
...
![](/uploads/images/posts/git/basic/git-workflows-forking.png)
...
![](/uploads/images/posts/git/basic/git-workflows-forking-1.png)
...
![](/uploads/images/posts/git/basic/git-workflows-forking-2.png)
...
![](/uploads/images/posts/git/basic/git-workflows-forking-3.png)
...
![](/uploads/images/posts/git/basic/git-workflows-forking-4.png)
...
![](/uploads/images/posts/git/basic/git-workflows-forking-5.png)
...
![](/uploads/images/posts/git/basic/git-workflows-forking-6.png)
...
![](/uploads/images/posts/git/basic/git-workflows-forking-7.png)
...
![](/uploads/images/posts/git/basic/pull-request-bitbucket.png)
...
![](/uploads/images/posts/git/basic/pull-request-overview.png)
...
![](/uploads/images/posts/git/basic/pull-request-anatomy.png)
...
![](/uploads/images/posts/git/basic/pull-request-feature-branch.png)
...
![](/uploads/images/posts/git/basic/gitflow-workflow-pull-request.png)
...
![](/uploads/images/posts/git/basic/pull-request-forking-workflow-1.png)
...
![](/uploads/images/posts/git/basic/pull-request-forking-workflow-2.png)
...
![](/uploads/images/posts/git/basic/pull-request-1.png)

小红先要`fork`小明的`Bitbucket`仓库，开始项目的开发。她登陆`Bitbucket`，浏览到小明的仓库页面，
点`Fork`按钮。

![](/uploads/images/posts/git/basic/pull-request-2.png)

然后为`fork`出来的仓库填写名字和描述，这样小红就有了服务端的项目拷贝了。

#### 小红克隆她的`Bitbucket`仓库

![](/uploads/images/posts/git/basic/pull-request-3.png)
...
![](/uploads/images/posts/git/basic/pull-request-4.png)
...
![](/uploads/images/posts/git/basic/pull-request-5.png)
...
![](/uploads/images/posts/git/basic/example-6.png)
...
![](/uploads/images/posts/git/basic/pull-request-7.png)

创建好了`Pull Request`，通知会通过`Bitbucket`系统消息或邮件（可选）发给小明。

#### 小明review `Pull Request`

![](/uploads/images/posts/git/basic/pull-request-8.png)
...
![](/uploads/images/posts/git/basic/pull-request-9.png)
...
![图片](/uploads/images/posts/git/basic/branch_module.png)
